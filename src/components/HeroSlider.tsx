            ...
            <div className="relative h-full w-full flex items-center">
              ...
              <div className="relative z-10 max-w-7xl mx-auto px-8 md:px-16 w-full pt-20">
                <div className="max-w-2xl">
                  ...
                  <h1 className="font-display font-black text-white leading-[1.05] mb-5"
                    style={{ fontSize: 'clamp(2rem, 5.5vw, 4.2rem)', textShadow: '0 2px 20px rgba(0,0,0,0.5)' }}>
                    {slide.title}
                  </h1>

                  <p className="text-white/75 font-body text-base md:text-lg leading-relaxed mb-8 max-w-xl">
                    {slide.subtitle}
                  </p>
